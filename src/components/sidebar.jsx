        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              {/* <span className="email"><i className="icon-mail"></i>myemail@gmail.com</span> */}
            </div>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  <br />
                  {/* <li className="active"><a href="#home" data-nav-section="home">Information</a></li> */}
            ...
            <nav id="colorlib-main-menu">
              <ul>
                {/* <li><a href="h" target="_blank" rel="noopener noreferrer"><i className="icon-facebook2" /></a></li>
                ...
                <li><a href="https://www.linkedin.com/in/danilo-y-661a8921" target="_blank" rel="noopener noreferrer"><i className="icon-linkedin2" /></a></li>
